<div id="getstarted-wrapper">
    <div class="container">
        <h2>GET STARTED WITH A FREE CONSULTATION AND HOME EVALUATION</h2>
        <br>
        <p>We have developed an easy way for all homeowners to inquiry if they qualify. Before filling out the simple questions below, here is some useful information for you to consider:
        </p>
        <p><strong>Do I qualify?</strong></p>
        <p>RESPONSE: Not everyone qualifies for solar. Meaning, some households may not qualify for solar based on the conditions of their current roof (we will evaluate that for you), the location of your home (how much sunlight your home receives)</p>
        <p><strong>Not every homeowner can qualify for financing.</strong></p>
        <p>RESPONSE: While we offer many options for those homeowners who wish to finance their solar installation, some homeowners may not qualify for financing. The good news is that most solar financing is geared towards specifically addressing the benefit of solar and will consider other factors that traditional lending does not take into account. For example, eliminating a large percentage of your energy bill per month.</p>
